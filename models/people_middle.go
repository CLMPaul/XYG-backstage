...
type PeopleMidSubjectItem struct {
	Id       int64
	PeopleId int64
	Item     string
}
type PeopleMid struct {
	CreatedAt        time.Time
	UpdatedAt        time.Time
	...
	PeopleSubject    []PeopleMidSubjectItem `json:"people_subject" gorm:"foreignKey:PeopleId;references:PeopleId"` // 人才具体擅长标签
